...
{
	public class GodsMagicMissle : ModItem
	{
		public override void SetStaticDefaults() {
			Tooltip.SetDefault("The power of the gods is in your controll."
				+ "\nUse it wisely.");
			DisplayName.SetDefault("God's Magic Missle");
		}

		public override void SetDefaults() {
			item.damage = 800000000;
			item.magic = true;
			item.mana = 14;
			item.width = 26;
			item.height = 26;
