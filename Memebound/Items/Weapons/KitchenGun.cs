...
namespace Memebound.Items.Weapons
{
	public class KitchenGun : ModItem
	{
		public override void SetStaticDefaults() {
			...
			Tooltip.SetDefault("The all new... KITCHEN GUN");
		}

		public override void SetDefaults() {
			item.damage = 9999999; // Sets the item's damage. Note that projectiles shot by this weapon will use its and the used ammunition's damage added together.
